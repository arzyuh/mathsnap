...
MVP опсег: **печатен текст + основен ракопис (цифри/оператори)**,
основна алгебра - линеарни равенки, квадратни равенки (факторизација +
квадратна формула), и симплификација на изрази.
